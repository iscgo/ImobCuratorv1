...
import { CURRENT_USER, MOCK_ACTIVITIES, MOCK_CLIENTS } from '../constants';
        ...
        <div className="space-y-6 lg:col-span-2">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 relative overflow-hidden group hover:border-indigo-200 dark:hover:border-indigo-800 transition-colors">
                    ...
                    <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-1">3 Visitas</h2>
                    <p className="text-gray-500 dark:text-gray-400 text-sm">Pendentes de confirmação hoje</p>
                ...
                <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-700 relative overflow-hidden group hover:border-green-200 dark:hover:border-green-800 transition-colors">
                    ...
                    <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-1">Ana Silva</h2>
                    <p className="text-gray-500 dark:text-gray-400 text-sm">Viu a proposta <span className="font-bold text-slate-900 dark:text-white">5x</span> recentemente</p>
