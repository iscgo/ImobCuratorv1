...
import { MOCK_VISITS_LIST, MOCK_CLIENTS, CURRENT_USER } from '../constants';
import { Visit, VisitStatus, Client } from '../types';

export const Visits: React.FC = () => {
  // --- DATA STATE (Now mutable) ---
  const [visits, setVisits] = useState<Visit[]>(MOCK_VISITS_LIST);
  ...
  const eligiblePdfClients = MOCK_CLIENTS.filter(c => clientsWithVisitsIds.includes(c.id));
